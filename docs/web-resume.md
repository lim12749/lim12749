...
자기소개를 바꾸면 데이터 파일과 Markdown 원문을 함께 수정합니다. 웹 이력서는 제공된 2026.08.05 PDF와 이후 사용자의 가우스랩·MYVR 경력 정정을 반영했고, 공개 이메일은 기존 GitHub 프로필에서 반영했습니다. 기존 README에만 있는 별도 사이드 프로젝트 소개는 유지했습니다.
