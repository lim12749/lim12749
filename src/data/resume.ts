...
export const experiences = [
  ...
  },
  {
    ...
    description: '게임·XR 클라이언트 개발과 외주 프로젝트 관리',
    highlights: [
      'Unity·C#으로 캐릭터 이동·전투·애니메이션, HUD·인벤토리·로비 UI를 구현했습니다.',
      'Photon 기반 실시간 멀티플레이어 매칭·상태 동기화와 리소스 관리·오브젝트 풀링을 담당했습니다.',
...
export const skillGroups = [
  ...
  { title: 'XR · Automation', items: ['C#', 'Unity', '.NET', 'HoloLens 2', 'Photon', 'Selenium'] },
